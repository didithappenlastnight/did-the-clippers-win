# clippers_bot.py
# Posts "Did the Los Angeles Clippers win last night?" using BallDontLie + X API.
...
TEAM_ABBR = "LAC"
TEAM_NICK = "Clippers"
TEAM_CITY_FULL = "Los Angeles Clippers"
...
def resolve_team_id():
    """
    Resolve Clippers team_id from BallDontLie to avoid hardcoding.
...
def main():
    ...
    if tweet is None:
        print("No Clippers game yesterday — nothing to post.")
        return
    post_to_x(tweet)
